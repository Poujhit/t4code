...
import { hasProviderTraitControls, TraitsMenuContent, TraitsPicker } from "./TraitsPicker";
import {
  ...
  const normalizedOptions =
    provider === "codex"
      ...
      : provider === "claudeAgent"
        ...
        : normalizeGitHubCopilotModelOptionsWithCapabilities(caps, providerOptions);
